...
class ReuTeefCombinatie {
    ...
    // ALLEEN DEZE FUNCTIE IS AANGEPAST VOOR DE TOEKOMSTIGE PUP POPUP
    addFuturePuppyClickHandler(futurePuppy, coiResult, healthAnalysis) {
        ...
        if (futurePuppyCard) {
            ...
            // Voeg ONZE eigen click handler toe met de verbeterde code
            newCard.addEventListener('click', async (e) => {
                ...
                try {
                    ...
                    // Toon popup met de verbeterde functie
    ...
    // NIEUW: showFuturePuppyPopup met EIGEN popup systeem - VERBETERDE VERSIE
