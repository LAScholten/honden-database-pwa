    ...
    getStyles() {
        return `
            <style>
                ...
                /* ============================================= */
                /* MOBIELE AANPASSINGEN - Popup vanaf 10px links */
                /* ============================================= */
                
                @media (max-width: 768px) {
                    .popup-content {
                        width: calc(100% - 20px) !important; /* 10px aan elke kant */
                        margin: 10px !important; /* Zorgt voor 10px ruimte links en rechts */
                    ...
                    /* Inline rows voor mobiel - soms stapelen */
                    .inline-row {
                        flex-direction: column;
                        gap: 15px;
                    }
                    ...
                    /* Gezondheidsgrid voor mobiel */
                    .health-grid {
                        grid-template-columns: 1fr;
                    }
                    
                    /* Ouders grid voor mobiel */
                    .parents-grid {
                        grid-template-columns: 1fr;
                    }
